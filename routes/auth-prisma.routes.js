...
// API endpoint to get remaining login attempts
router.get('/attempts-remaining', (req, res) => {
  try {
    ...
    const response = {
      success: true,
      data: {
        attemptsRemaining: attemptCheck.attemptsRemaining || authConfig.login.maxAttempts,
        maxAttempts: authConfig.login.maxAttempts,
        isBlocked: !attemptCheck.allowed,
        cooldownRemaining: attemptCheck.cooldownRemaining || 0
      }
    };
